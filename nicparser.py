...
def NICParser(nic):
    ...
    try:
        special_letter=matches.group(5)
    except IndexError:
        special_letter=None
    return Struct(birth_year=int(year),
                  ...
                  special_letter=special_letter if special_letter
                  and special_letter not in '1234567890' else None,
                  id_type=_type,
                  can_vote=special_letter and special_letter == 'v')
